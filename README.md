...
against a user-defined comfort setpoint, and automatically activates or deactivates a heating/cooling
relay. All data is persisted to SQLite and visualized through a live Tkinter & Matplotlib GUI.
